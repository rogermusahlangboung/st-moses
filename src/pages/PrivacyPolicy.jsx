  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-3xl mx-auto px-6 py-20">
        ...
        <h1 className="font-display font-extrabold text-4xl sm:text-5xl text-ink mb-8">Privacy Policy</h1>
        <div className="prose prose-gray max-w-none space-y-6 text-muted leading-relaxed">
          ...
          <h2 className="font-display font-bold text-2xl text-ink mt-10">Information We Collect</h2>
          ...
          <h2 className="font-display font-bold text-2xl text-ink mt-10">How We Use Your Information</h2>
          ...
          <h2 className="font-display font-bold text-2xl text-ink mt-10">Data Protection</h2>
