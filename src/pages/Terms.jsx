  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-3xl mx-auto px-6 py-20">
        <Link to="/" className="inline-flex items-center gap-2 text-primary hover:text-primary-dark font-medium mb-10 lift-on-hover">
          <ArrowLeft className="h-4 w-4" /> Back to Home
        </Link>
        <h1 className="font-display font-extrabold text-4xl sm:text-5xl text-ink mb-8">Terms &amp; Conditions</h1>
        <div className="prose prose-gray max-w-none space-y-6 text-muted leading-relaxed">
          ...
          <h2 className="font-display font-bold text-2xl text-ink mt-10">Medical Disclaimer</h2>
          ...
          <h2 className="font-display font-bold text-2xl text-ink mt-10">Appointments &amp; Services</h2>
          ...
          <h2 className="font-display font-bold text-2xl text-ink mt-10">Liability</h2>
          ...
          <h2 className="font-display font-bold text-2xl text-ink mt-10">Changes</h2>
