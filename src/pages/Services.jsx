...
const ALL_SERVICES = [
  ...
  { icon: HeartPulse, title: 'Dietitian and Dietetic', text: 'Professional nutrition assessment, dietary counselling, and personalised meal planning to support recovery, disease management, and long-term wellbeing.', image: '/dietitian.jpg', bullets: ['Individual nutrition assessment and dietary counselling', 'Personalised meal plans for medical and wellness goals', 'Nutrition support for diabetes, hypertension, weight management, and recovery'] },
