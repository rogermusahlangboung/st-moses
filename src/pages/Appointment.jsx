        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mt-8 text-center">
            <p className="text-muted text-xs leading-relaxed">
              Prefer to call? <a href="tel:0243474002" className="text-primary hover:underline font-medium">0243-474002</a> &nbsp;|&nbsp; 
              <a href="tel:0208631116" className="text-primary hover:underline font-medium"> 020-8631116</a>
            </p>
          </div>
        </div>
      </section>
